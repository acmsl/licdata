...
"""
org/acmsl/licdata/iac/infrastructure/cli/pulumi_options_cli.py
...
class PulumiOptionsCli(CliHandler, PrimaryPort):
    ...
    Collaborators:
        - org.acmsl.licdata.iac.application.LicdataIacApp: It's notified back with the information retrieved from the command line.
    """
