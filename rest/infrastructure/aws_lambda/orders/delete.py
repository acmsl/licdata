"""
licdata/rest/infrastructure/aws_lambda/orders/delete.py
...
import infrastructure.aws_lambda.orders.common
...
def handler(event, context) -> Dict:
    ...
    :rtype: Dict
    """
    return rest.delete(event, context, Licdata.instance().get_repo(OrderRepo))
