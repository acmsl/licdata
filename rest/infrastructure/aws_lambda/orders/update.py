"""
licdata/rest/infrastructure/aws_lambda/orders/update.py

This file provides an AWS Lambda handler to update existing orders.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to update orders.
