"""
licdata/rest/infrastructure/aws_lambda/pcs/find_by_id.py

This file provides an AWS Lambda handler to find PCs by id.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to find PCSs by id.
