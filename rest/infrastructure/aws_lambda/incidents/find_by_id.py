"""
licdata/rest/infrastructure/aws_lambda/incidents/find_by_id.py

This file provides an AWS Lambda handler to find incidents by id.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to find incidents by id.
