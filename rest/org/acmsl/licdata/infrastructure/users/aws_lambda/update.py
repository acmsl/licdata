"""
org/acmsl/licdata/infrastructure/aws_lambda/users/update.py

This file provides an AWS Lambda handler to update existing users.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to update users.
