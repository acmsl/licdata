"""
org/acmsl/licdata/infrastructure/aws_lambda/licenses/find_by_id.py

This file provides an AWS Lambda handler to find licenses by id.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to find licenses by id.
    ...
    :rtype: Dict
    """
    return rest.find_by_id(event, context, Licdata.instance().get_repo(LicenseRepo))
