"""
org/acmsl/licdata/infrastructure/aws_lambda/licenses/update.py

This file provides an AWS Lambda handler to update existing licenses.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to update licenses.
    ...
    return rest.update(
        ...
        Licdata.instance().get_repo(LicenseRepo),
    )
