"""
org/acmsl/licdata/infrastructure/aws_lambda/orders/common.py

This file provides some methods used by order-related handlers.
...
def retrieve_pk(body: Dict, event) -> Dict:
    """
    Retrieves the order's primary key from given body/event.
    :param body: The body.
    :type body: Dict
...
def retrieve_attributes(body: Dict, event) -> Dict:
    """
    Retrieves the order's attributes from given body/event.
    :param body: The body.
    :type body: Dict
    :param event: The AWS Lambda event.
    :type event: event
