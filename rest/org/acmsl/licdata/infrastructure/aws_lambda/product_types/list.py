"""
org/acmsl/licdata/infrastructure/aws_lambda/product_types/list.py

This file provides an AWS Lambda handler to list product types.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to list product types.
