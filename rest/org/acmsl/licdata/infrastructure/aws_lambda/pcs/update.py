"""
org/acmsl/licdata/infrastructure/aws_lambda/pcs/update.py

This file provides an AWS Lambda handler to update existing PCs.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to update PCs.
    ...
    """
    return rest.update(
        event, context, common.retrieve_attributes, Licdata.instance().get_repo(PcRepo)
    )
