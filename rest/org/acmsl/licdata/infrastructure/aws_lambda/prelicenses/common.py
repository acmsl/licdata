"""
org/acmsl/licdata/infrastructure/aws_lambda/prelicenses/common.py

This file provides some methods used by prelicenses-related handlers.
...
from org.acmsl.licdata.domain import Prelicense
...
def retrieve_pk(body: Dict, event) -> Dict:
    """
    Retrieves the prelicense's primary key from given body/event.
    :param body: The body.
    :type body: Dict
...
def retrieve_attributes(body: Dict, event) -> Dict:
    """
    Retrieves the prelicense's attributes from given body/event.
    :param body: The body.
    :type body: Dict
    :param event: The AWS Lambda event.
    :type event: event
