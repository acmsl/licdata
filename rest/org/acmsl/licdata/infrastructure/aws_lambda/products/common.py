"""
org/acmsl/licdata/infrastructure/aws_lambda/products/common.py

This file provides some methods used by product-related handlers.
...
def retrieve_pk(body: Dict, event) -> Dict:
    """
    Retrieves the product's primary key from given body/event.
    :param body: The body.
    :type body: Dict
...
def retrieve_attributes(body: Dict, event) -> Dict:
    """
    Retrieves the product's attributes from given body/event.
    :param body: The body.
    :type body: Dict
    :param event: The AWS Lambda event.
    :type event: event
