"""
org/acmsl/licdata/infrastructure/clients/aws_lambda/list.py

This file provides an AWS Lambda handler to list clients.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to list clients.
    ...
    :rtype: Dict
    """
    return rest.list(event, context, LicdataApp.instance().get_repo(ClientRepo))
