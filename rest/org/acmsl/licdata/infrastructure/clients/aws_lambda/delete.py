"""
org/acmsl/licdata/infrastructure/clients/aws_lambda/delete.py

This file provides an AWS Lambda handler to delete existing clients.
...
def handler(event, context) -> Dict:
    """
    AWS Lambda handler to delete a client.
    ...
    :rtype: Dict
    """
    return rest.delete(event, context, LicdataApp.instance().get_repo(ClientRepo))
